...
static constexpr PortService TOP100_TCP_MAP[] = {
    ...
    {26, Layer4Protocol::TCP, "smtp-alt"},
    {37, Layer4Protocol::TCP, "time"},
    {53, Layer4Protocol::TCP, "dns"},
    {79, Layer4Protocol::TCP, "finger"},
    {80, Layer4Protocol::TCP, "http"},
    {81, Layer4Protocol::TCP, "http-alt"},
    {88, Layer4Protocol::TCP, "kerberos"},
    ...
    {1025, Layer4Protocol::TCP, "msrpc"},
    {1026, Layer4Protocol::TCP, "dcom"},
    {1027, Layer4Protocol::TCP, "iis"},
    {1028, Layer4Protocol::TCP, "ms-lsa"},
    {1029, Layer4Protocol::TCP, "ms-lsa"},
    ...
    {5000, Layer4Protocol::TCP, "http-alt"},
    ...
    {5900, Layer4Protocol::TCP, "vnc"},
    {6000, Layer4Protocol::TCP, "x11"},
    {6001, Layer4Protocol::TCP, "x11-1"},
    {6646, Layer4Protocol::TCP, "mcafee-net-agent"},
    ...
    {32768, Layer4Protocol::TCP, "omad"},
    {49152, Layer4Protocol::TCP, "msrpc-dynamic"},
    {49153, Layer4Protocol::TCP, "msrpc-dynamic"},
    {49154, Layer4Protocol::TCP, "msrpc-dynamic"},
    {49155, Layer4Protocol::TCP, "msrpc-dynamic"},
    {49156, Layer4Protocol::TCP, "msrpc-dynamic"},
    {49157, Layer4Protocol::TCP, "msrpc-dynamic"},
};
...
static constexpr PortService TOP100_UDP_MAP[] = {
    ...
    {53,   Layer4Protocol::UDP, "dns"},
    {67,   Layer4Protocol::UDP, "dhcps"},
    {68,   Layer4Protocol::UDP, "dhcpc"},
    {69,   Layer4Protocol::UDP, "tftp"},
    {80,   Layer4Protocol::UDP, "http-alt"},
    {88,   Layer4Protocol::UDP, "kerberos"},
    ...
    {139,  Layer4Protocol::UDP, "netbios-ssn"},
    ...
    {1433, Layer4Protocol::UDP, "ms-sql-m"},
    {1434, Layer4Protocol::UDP, "ms-sql-s"},
    ...
    {3283, Layer4Protocol::UDP, "apple-remote-mgmt"},
    ...
    {49152,Layer4Protocol::UDP, "ephemeral"},
    {49153,Layer4Protocol::UDP, "ephemeral"},
    {49154,Layer4Protocol::UDP, "ephemeral"},
    {49156,Layer4Protocol::UDP, "ephemeral"},
    {49181,Layer4Protocol::UDP, "ephemeral"},
    {49182,Layer4Protocol::UDP, "ephemeral"},
    {49185,Layer4Protocol::UDP, "ephemeral"},
    {49186,Layer4Protocol::UDP, "ephemeral"},
    {49188,Layer4Protocol::UDP, "ephemeral"},
    {49190,Layer4Protocol::UDP, "ephemeral"},
    {49191,Layer4Protocol::UDP, "ephemeral"},
    {49192,Layer4Protocol::UDP, "ephemeral"},
    {49193,Layer4Protocol::UDP, "ephemeral"},
    {49194,Layer4Protocol::UDP, "ephemeral"},
    {49200,Layer4Protocol::UDP, "ephemeral"},
    {49201,Layer4Protocol::UDP, "ephemeral"},
