(() => {
  ...
  style.textContent = `
    ...
    html[data-theme="light"] :is(.intent-card,.signal-card,.destination-card,.recipe-index-grid a,.note-card,.problem-card,.faq-list details,.step-list li) { background:linear-gradient(145deg,#ffffff,#f0f6f2) !important; border-color:#b9c9c0 !important; color:#183128 !important; box-shadow:0 8px 22px rgba(31,72,53,.08), inset 0 0 4px rgba(28,57,43,.05) !important; }
    ...
    html[data-theme="light"] :is(.intent-card span,.signal-card span,.recipe-index-grid span,.note-card span,.problem-card span,.step-list span) { color:#007f7a !important; }
    ...
    html[data-theme="light"] :is(.intent-card h3,.signal-card h3,.destination-card h3,.recipe-index-grid strong,.faq-list summary) { color:#087345 !important; }
    html[data-theme="light"] :is(.lead,.section-intro,.step-list p,.intent-card p,.signal-card p,.destination-card p,.note-card p,.problem-card p,.recipe-index-grid small,.faq-list p,.command-note) { color:#355448 !important; }
